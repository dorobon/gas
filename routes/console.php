...
Artisan::command('fuel:about', function () {
    $this->components->twoColumnDetail('Fuente XLS', config('fuel.source_url'));
    $this->components->twoColumnDetail('Fuente REST', config('fuel.rest_source_url'));
    $this->components->twoColumnDetail('Estrategia importación', config('fuel.import_strategy'));
